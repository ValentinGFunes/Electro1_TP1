...
rticks, rticks_labels = [0,-3,-6,-9,-12,-15,-18],["0dB","-3dB","-6dB","-9dB","-12dB","-15dB","-18dB"]
...
for row in range (9):
    ...
    if row == 1:
        ax_NT2000_Fig8 [row%2].plot (degree_NT2000_negat, amplitudes, color="green", linestyle="dotted", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 2:
        ax_NT2000_Fig8 [row%2].plot (degree_NT2000_posit, amplitudes, color="black", linestyle="dotted", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 3:
        ax_NT2000_Fig8 [row%2].plot (degree_NT2000_negat, amplitudes, color="black", linestyle="dashed", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 4:
        ax_NT2000_Fig8 [row%2].plot (degree_NT2000_posit, amplitudes, color="orange", linestyle="dashed", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 5:
        ax_NT2000_Fig8 [row%2].plot (degree_NT2000_negat, amplitudes, color="orange", linestyle="dashdot", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 6:
        ax_NT2000_Fig8 [row%2].plot (degree_NT2000_posit, amplitudes, color="red", linestyle="dashdot", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)        
    if row == 7:
        ax_NT2000_Fig8 [row%2].plot (degree_NT2000_negat, amplitudes, color="red", linestyle=(0,(3,5,1,5,1,5)), label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 8:
        ax_NT2000_Fig8 [row%2].plot (degree_NT2000_posit, amplitudes, color="blue", linestyle=(0,(3,5,1,5,1,5)), label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    fig.suptitle ("Patrón polar para RODE NT2000 bidireccional",fontsize=38)
    ...
    ax_NT2000_Fig8 [0].grid (linewidth=3)
    ax_NT2000_Fig8 [0].legend (loc="upper left",fontsize=28)
    ax_NT2000_Fig8 [0].tick_params (axis="x", pad=20, labelsize=34)
    ax_NT2000_Fig8 [0].tick_params (axis="y", pad=5, labelsize=34, labelrotation=0)
    ...
    ax_NT2000_Fig8 [1].grid (linewidth=3)
    ax_NT2000_Fig8 [1].legend (loc="upper right",fontsize=28)
    ax_NT2000_Fig8 [1].tick_params (axis="x", pad=20, labelsize=34)
    ax_NT2000_Fig8 [1].tick_params (axis="y", pad=5, labelright=True, labelleft=False, labelsize=34, labelrotation=0)
...
for row in range (9):
    ...
    if row == 1:
        ax_NT2000_Cardioid [row%2].plot (degree_NT2000_negat, amplitudes, color="green", linestyle="dotted", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 2:
        ax_NT2000_Cardioid [row%2].plot (degree_NT2000_posit, amplitudes, color="black", linestyle="dotted", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 3:
        ax_NT2000_Cardioid [row%2].plot (degree_NT2000_negat, amplitudes, color="black", linestyle="dashed", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 4:
        ax_NT2000_Cardioid [row%2].plot (degree_NT2000_posit, amplitudes, color="orange", linestyle="dashed", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 5:
        ax_NT2000_Cardioid [row%2].plot (degree_NT2000_negat, amplitudes, color="orange", linestyle="dashdot", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 6:
        ax_NT2000_Cardioid [row%2].plot (degree_NT2000_posit, amplitudes, color="red", linestyle="dashdot", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)        
    if row == 7:
        ax_NT2000_Cardioid [row%2].plot (degree_NT2000_negat, amplitudes, color="red", linestyle=(0,(3,5,1,5,1,5)), label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 8:
        ax_NT2000_Cardioid [row%2].plot (degree_NT2000_posit, amplitudes, color="blue", linestyle=(0,(3,5,1,5,1,5)), label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    fig.suptitle ("Patrón polar para RODE NT2000 Cardioide",fontsize=38)
    ...
    ax_NT2000_Cardioid [0].grid (linewidth=3)
    ax_NT2000_Cardioid [0].legend (loc="upper left",fontsize=28)
    ax_NT2000_Cardioid [0].tick_params (axis="x", pad=20, labelsize=34)
    ax_NT2000_Cardioid [0].tick_params (axis="y", pad=5, labelsize=34, labelrotation=0)
    ...
    ax_NT2000_Cardioid [1].grid (linewidth=3)
    ax_NT2000_Cardioid [1].set_rgrids (rticks,rticks_labels)
    ax_NT2000_Cardioid [1].legend (loc="upper right",fontsize=28)
    ax_NT2000_Cardioid [1].tick_params (axis="x", pad=20, labelsize=34)
    ax_NT2000_Cardioid [1].tick_params (axis="y", pad=5, labelright=True, labelleft=False, labelsize=34, labelrotation=0)
    plt.subplots_adjust(wspace=0)
#%%
...
for row in range (9):
    ...
    if row == 1:
        ax_SM57 [row%2].plot (degree_SM57_negat, amplitudes, color="green", linestyle="dotted", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 2:
        ax_SM57 [row%2].plot (degree_SM57_posit, amplitudes, color="black", linestyle="dotted", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 3:
        ax_SM57 [row%2].plot (degree_SM57_negat, amplitudes, color="black", linestyle="dashed", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 4:
        ax_SM57 [row%2].plot (degree_SM57_posit, amplitudes, color="orange", linestyle="dashed", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 5:
        ax_SM57 [row%2].plot (degree_SM57_negat, amplitudes, color="orange", linestyle="dashdot", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 6:
        ax_SM57 [row%2].plot (degree_SM57_posit, amplitudes, color="red", linestyle="dashdot", label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)        
    if row == 7:
        ax_SM57 [row%2].plot (degree_SM57_negat, amplitudes, color="red", linestyle=(0,(3,5,1,5,1,5)), label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    if row == 8:
        ax_SM57 [row%2].plot (degree_SM57_posit, amplitudes, color="blue", linestyle=(0,(3,5,1,5,1,5)), label= str(int(matrix_NT2000_Fig8[row,0]))+"Hz",linewidth=5)
    fig.suptitle ("Patrón polar para Shure SM57",fontsize=38)
    ...
    ax_SM57 [0].grid (linewidth=3)
    ax_SM57 [0].legend (loc="upper left",fontsize=28)
    ax_SM57 [0].tick_params (axis="x", pad=20, labelsize=34)
    ax_SM57 [0].tick_params (axis="y", pad=5, labelsize=34, labelrotation=0)
    ...
    ax_SM57 [1].grid (linewidth=3)
    ax_SM57 [1].legend (loc="upper right",fontsize=28)
    ax_SM57 [1].tick_params (axis="x", pad=20, labelsize=34)
    ax_SM57 [1].tick_params (axis="y", pad=5, labelright=True, labelleft=False, labelsize=34, labelrotation=0)
    plt.subplots_adjust(wspace=0) 
